...
try {
  ...
  } else if (hostname.endsWith("upscale.io")) {
    __baseApiUrl__ = "https://api.upscale.io"; // production
  } else {
    __baseApiUrl__ = "https://api.upscale.io"; // fallback to prod
  }
} catch (_) {
  __baseApiUrl__ = "https://api.upscale.io";
}
